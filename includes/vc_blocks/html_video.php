...
vc_map( array(
    ...
    "name"      => __("HTML5 Video", 'luxortheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("WebM video", 'luxortheme'),
            "param_name" => "el_webm",
            "description" => __("Enter the URL path to your WebM formatted video.", 'luxortheme'),
			"value" => ''
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("MP4 video", 'luxortheme'),
            "param_name" => "el_mp4",
            "description" => __("Enter the URL path to your MP4 formatted video.", 'luxortheme'),
			"value" => ''
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("OGG video", 'luxortheme'),
            "param_name" => "el_ogg",
            "description" => __("Enter the URL path to your OGG formatted video.", 'luxortheme'),
			"value" => ''
        ),
		...
		array(
            ...
            "param_name" => "content",
            "description" => __("Enter content if required.", 'luxortheme'),
			"value" => ''
        ),
